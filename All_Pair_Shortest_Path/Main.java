...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("MatrixMultiplication.txt"));
        BufferedWriter bw2 = new BufferedWriter(new FileWriter("Floyd.txt"));
        ...
        for (int i = 0; i < m; i++) {
            ...
            g1.addEdge(v - 1, w - 1, weight);
        }
        bw.write((new MatrixMultiplication(g1)).toString());
        bw2.write(new Floyd(g1).toString());
        br.close();
        bw.close();
        bw2.close();
